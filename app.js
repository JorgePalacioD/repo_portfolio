...
const projects = [
  {
    ...
    description:
      "En este proyecto manipulamos los estilos del DOM para cambiar el modo de la pantalla",
  ...
  },
  {
    ...
    description:
      "Utiizando la app de emailjs y ayudados de React, creamos un formulario de contáctenos",
  ...
  },
  {
    ...
    description:
      "Practicando eventos del DOM, hemos realizado el popular juego: Piedra Papel o tijera",
  ...
  },
  {
    ...
    description:
      "Consumiendo nuestra primera Api con la popular serie de Rick and morty, aplicando asincronismo",
  ...
  },
  {
    ...
    description:
      "En este proyecto aplicamo conceptos básicos de web socket, con la librería sockwet.io",
  ...
  },
  {
    ...
    description:
      "Es una de las primeras prácticas donde almacenamos en local storag los elementos del carrito",
